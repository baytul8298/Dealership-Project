...
watch(
  ...
  (newModule) => {
    if (newModule && props.mode === 'edit') {
      form.module_name = newModule.module_name
    } else {
      form.reset()
    }
  },
...
const modalTitle = computed(() => {
  return props.mode === 'create' ? 'Create Module' : 'Edit Module'
})
            ...
            <form @submit.prevent="handleSubmit" class="card-body space-y-4">
              ...
              <div>
                <FormInput
                  ...
                  :error="form.errors.module_name"
                  :disabled="form.processing"
                  required
                />
                <p class="mt-1 text-xs text-gray-500">
                  Enter a unique name for this module
                </p>
              </div>
